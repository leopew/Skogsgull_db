...
<div id="free-pro-panel" class="panel-left">
	<div class="panel-aside">               		
		<img src="<?php echo esc_url( get_template_directory_uri() . '/inc/getting-started/images/free-vs-pro.jpg' ); ?>" alt="<?php esc_attr_e( 'Free vs Pro', 'cookery-lite' ); ?>"/>
		<a class="button button-primary" href="<?php echo esc_url( 'https://blossomthemes.com/downloads/cookery-lite-pro/' ); ?>" title="<?php esc_attr_e( 'View Premium Version', 'cookery-lite' ); ?>" target="_blank">
            <?php esc_html_e( 'View Pro', 'cookery-lite' ); ?>
        </a>
	</div><!-- .panel-aside -->
</div>